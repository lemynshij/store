...
ActiveRecord::Schema.define(version: 20170107204555) do
  ...
  create_table "categories", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["name", "parent_id"], name: "index_categories_on_name_and_parent_id", using: :btree
    t.index ["parent_id", "name"], name: "index_categories_on_parent_id_and_name", using: :btree
  end
  ...
  create_table "dandh_products", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string   "name",                                default: ""
    t.text     "marketing_description", limit: 65535
    t.text     "tech_description",      limit: 65535
    ...
    t.float    "msrp",                  limit: 24,    default: 0.0
    t.float    "reseller_price",        limit: 24,    default: 0.0
  ...
  create_table "dsdi_products", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.index ["name"], name: "index_dsdi_products_on_name", unique: true, using: :btree
    t.index ["vendor_product_id"], name: "index_dsdi_products_on_dsdi_product_id", using: :btree
  end

  create_table "ingram_micro_products", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.float    "retail_price",              limit: 24, default: 0.0
    t.string   "vendor_part_number",                   default: ""
    t.float    "weight",                    limit: 24, default: 0.0
    t.string   "upc_code",                             default: ""
    t.float    "legnth",                    limit: 24, default: 0.0
    t.float    "width",                     limit: 24, default: 0.0
    t.string   "price_change_flag",                    default: ""
    t.float    "customer_price",            limit: 24, default: 0.0
    t.float    "special_price_flag",        limit: 24, default: 0.0
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["ingram_sku"], name: "index_ingram_micro_products_on_ingram_sku", unique: true, using: :btree
    t.index ["spex_essential_product_id"], name: "index_ingram_micro_products_on_spex_essential_product_id", unique: true, using: :btree
  end
  ...
  create_table "product_images", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.index ["product_id", "parent_id"], name: "index_product_images_on_product_id_and_parent_id", using: :btree
  end
  ...
  create_table "products", force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=latin1" do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.float    "map",            limit: 24,    default: 0.0
    t.integer  "category_id",                  default: 0,    null: false
    t.string   "upc_code",                     default: ""
    t.string   "availability",                 default: "NA"
    t.index ["category_id"], name: "index_products_on_category_id", using: :btree
    t.index ["title", "description", "manufacturer"], name: "fulltext_product", type: :fulltext
  end
  ...
  create_table "spex_essential_products", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.text    "marketing_text",        limit: 65535
    t.text    "tech_specs",            limit: 65535
    t.string  "image_url",             limit: 100
    t.string  "etilize_creation_date", limit: 50
    t.string  "etilize_modified_date", limit: 50
    t.index ["dandh_sku"], name: "index_spex_essential_products_on_dandh_sku", using: :btree
    t.index ["etilize_product_id"], name: "index_spex_essential_products_on_etilize_product_id", using: :btree
    t.index ["ingram_sku"], name: "index_spex_essential_products_on_ingram_sku", using: :btree
  end
